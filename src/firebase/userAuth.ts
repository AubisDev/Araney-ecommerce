...
import { createUserWithEmailAndPassword, getIdToken, GoogleAuthProvider, signInWithEmailAndPassword, signInWithPopup, updateProfile, User, UserCredential } from "firebase/auth";
import {  NavigateFunction } from "react-router-dom";
import { registerUserWithEmailAndPassword, setUserData, UserLogInWithGoogle, userLogout, userSignInWithEmailAndPassword } from "../redux/states/user";
...
export const handleUserRegistration = async({ dispatch, username, email, password, navigate }:UserRegistrationProps) => {
...
export const userSignIn = async({dispatch, email, password, navigate}:EmailAndPasswordProps) => {
