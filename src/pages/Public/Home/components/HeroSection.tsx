...
export const HeroSection = () => {
  return (
    <Box sx={{ width: '100vw', height: '70vh', display:'flex',   }}>
        <Box sx={{ width: '90%', height: '100%', display:'flex', margin:'auto', position:"relative", color:'#1976d2' }}>
            ...
            <Box sx={{position:"absolute", left:0, right:0, top:0, bottom: 0, margin:'auto auto', width:'550px', height:'440px'}}>
                ...
                <Typography variant="h2" component="h2" align="center" sx={{ width: '80%', margin:"auto", pt:2, fontWeight:700, color:"#ed41ef"}}>
                    -50% descuento
                </Typography>
