...
import { getTotalItems, getTotalPrice, NotImplementedAlert } from "../utilities/generalPurpose";
...
const PurchaseDetails = ({products}:PurchaseDetailsProps) => {
    ...
    return (
        ...
        >
          ...
          <Typography variant="h6" fontFamily='Dosis' color='black' fontWeight={600} py={1.5} letterSpacing={2}>${getTotalPrice(products)}</Typography>
          ...
          <Button 
            ...
            variant="contained"  
            color='inherit'  
            sx={{ py:1.5, backgroundColor:'secondary.dark',  }}
